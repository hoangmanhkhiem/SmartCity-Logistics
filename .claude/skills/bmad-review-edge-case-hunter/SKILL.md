...
```json
[{
  "location": "path/to/file.ts:line_from:line_to (e.g. src/auth/auth.service.ts:42:57). If single line (e.g. src/auth/auth.service.ts:42). If exact line unavailable, use the nearest hunk range. Never use a dash separator.",
